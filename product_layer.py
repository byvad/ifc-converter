...
from ifc_schema import Domain, InterOperability, classify_instance
...
def discipline_products(model):
    ...
    Useful sanity check. A purely architectural model returns almost nothing
    here, because IfcWall and friends live one layer down in Interoperability.
    """
